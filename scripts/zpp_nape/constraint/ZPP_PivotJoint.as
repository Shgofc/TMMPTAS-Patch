package zpp_nape.constraint
{
   ...
   public class ZPP_PivotJoint extends ZPP_Constraint
   {
      ...
      override public function warmStart() : void
      {
         ...
         _temp_1.velx -= jAccx * _loc1_;
         _temp_2.vely -= jAccy * _loc1_;
         _loc1_ = b2.imass;
         _temp_3.velx += jAccx * _loc1_;
         _temp_4.vely += jAccy * _loc1_;
         _temp_5.angvel -= (jAccy * a1relx - jAccx * a1rely) * b1.iinertia;
         _temp_6.angvel += (jAccy * a2relx - jAccx * a2rely) * b2.iinertia;
      }
      ...
      override public function preStep(param1:Number) : Boolean
      {
         ...
         if(!stiff)
         {
            ...
            {
               _loc8_ = _loc4_ * ((_loc9_ = lf32((si32(((sf32(_loc5_,0),1597463007)) - (li32(0) >> 1),0),0))) * (1.5 - 0.5 * _loc5_ * _loc9_ * _loc9_));
               biasx *= _loc8_;
               biasy *= _loc8_;
            }
         }
      ...
      override public function applyImpulseVel() : Boolean
      {
         ...
         else if(!stiff)
         {
            ...
            {
               _loc9_ = _loc7_ * ((_loc10_ = lf32((si32(((sf32(_loc8_,0),1597463007)) - (li32(0) >> 1),0),0))) * (1.5 - 0.5 * _loc8_ * _loc10_ * _loc10_));
               jAccx *= _loc9_;
               jAccy *= _loc9_;
            }
         }
         ...
         _loc4_ = jAccy - _loc6_;
         _loc5_ = b1.imass;
         _temp_3.velx -= _loc3_ * _loc5_;
         _temp_4.vely -= _loc4_ * _loc5_;
         _loc5_ = b2.imass;
         _temp_5.velx += _loc3_ * _loc5_;
         _temp_6.vely += _loc4_ * _loc5_;
         _temp_7.angvel -= (_loc4_ * a1relx - _loc3_ * a1rely) * b1.iinertia;
         _temp_8.angvel += (_loc4_ * a2relx - _loc3_ * a2rely) * b2.iinertia;
         return false;
      }
      ...
      override public function applyImpulsePos() : Boolean
      {
         ...
         if(_loc5_ * _loc5_ + _loc6_ * _loc6_ > 6)
         {
            ...
            if(_loc9_ > 1e-8)
            {
               ...
               {
                  _loc12_ = _loc10_ * ((_loc13_ = lf32((si32(((sf32(_loc11_,0),1597463007)) - (li32(0) >> 1),0),0))) * (1.5 - 0.5 * _loc11_ * _loc13_ * _loc13_));
                  _loc7_ *= _loc12_;
                  _loc8_ *= _loc12_;
               }
               _loc11_ = b1.imass;
               _temp_4.posx -= _loc7_ * _loc11_;
               _temp_5.posy -= _loc8_ * _loc11_;
               _loc11_ = b2.imass;
               _temp_6.posx += _loc7_ * _loc11_;
               _temp_7.posy += _loc8_ * _loc11_;
               _loc5_ = b2.posx + _loc3_ - (b1.posx + _loc1_);
               _loc6_ = b2.posy + _loc4_ - (b1.posy + _loc2_);
               _loc11_ = 0.5;
               _loc5_ *= _loc11_;
         ...
         _loc11_ = 0;
         _loc12_ = 0;
         _loc9_ = _loc13_ = b1.smass + b2.smass;
         _loc11_ = 0;
         _loc12_ = _loc13_;
         if(b1.sinertia != 0)
         {
         ...
         {
            _loc14_ = _loc10_ * ((_loc15_ = lf32((si32(((sf32(_loc13_,0),1597463007)) - (li32(0) >> 1),0),0))) * (1.5 - 0.5 * _loc13_ * _loc15_ * _loc15_));
            _loc7_ *= _loc14_;
            _loc8_ *= _loc14_;
         }
         ...
         _loc13_ = b1.imass;
         _temp_14.posx -= _loc7_ * _loc13_;
         _temp_15.posy -= _loc8_ * _loc13_;
         _loc13_ = b2.imass;
         _temp_16.posx += _loc7_ * _loc13_;
         _temp_17.posy += _loc8_ * _loc13_;
