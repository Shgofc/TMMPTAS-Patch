package zpp_nape.util
{
   ...
   public class ZPP_ShapeDebug extends ZPP_Debug
   {
      ...
      public function draw_space(param1:ZPP_Space, param2:ZPP_Mat23, param3:Number, param4:Boolean) : void
      {
         ...
         if(outer.drawCollisionArbiters || outer.drawFluidArbiters || outer.drawSensorArbiters)
         {
            ...
            while(true)
            {
               ...
               var _temp_11:* = _loc16_.zpp_inner;
               _loc16_.zpp_i = (_loc20_ = _loc16_.zpp_i) + 1;
               _loc19_ = _temp_11.at(_loc20_);
      ...
      public function draw_shape(param1:ZPP_Shape, param2:ZPP_Mat23, param3:Number, param4:Boolean) : void
      {
         ...
         {
            _loc6_ = 16777215 * Math.exp(-(int(param1.id % 500)) / 1500);
         }
         else
         {
         ...
         if(_loc10_ != null)
         {
            ...
            _loc13_ = _loc6_;
            _loc7_ = 0.2;
            _loc14_ = (_loc11_ >> 16 & 0xFF) * _loc7_ + (_loc13_ >> 16 & 0xFF) * (1 - _loc7_);
            _loc15_ = (_loc11_ >> 8 & 0xFF) * _loc7_ + (_loc13_ >> 8 & 0xFF) * (1 - _loc7_);
            _loc16_ = (_loc11_ & 0xFF) * _loc7_ + (_loc13_ & 0xFF) * (1 - _loc7_);
                     ...
                     if(_loc17_.zip_localCOM)
                     {
                        ...
                        if(_loc17_.type == ZPP_Flags.id_ShapeType_POLYGON)
                        {
                           ...
                           else
                           {
                              ...
                              _loc18_.localCOMy = 0;
                              _loc7_ = 0;
                              _loc20_ = _loc18_.lverts.next;
                              _loc21_ = _loc20_.next;
                              _loc19_ = _loc21_.next;
                              while(_loc19_ != null)
                              {
                                 _loc22_ = _loc19_;
                              ...
                              _loc22_ = _loc19_ = _loc18_.lverts.next;
                              _loc7_ += _loc21_.x * (_loc22_.y - _loc20_.y);
                              _loc8_ = _loc22_.y * _loc21_.x - _loc22_.x * _loc21_.y;
                              _loc18_.localCOMx += (_loc21_.x + _loc22_.x) * _loc8_;
                              _loc18_.localCOMy += (_loc21_.y + _loc22_.y) * _loc8_;
                        ...
                        if(_loc18_.zip_localCOM)
                        {
                           ...
                           if(_loc18_.type == ZPP_Flags.id_ShapeType_POLYGON)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc29_.localCOMy = 0;
                                 _loc26_ = 0;
                                 _loc21_ = _loc29_.lverts.next;
                                 _loc22_ = _loc21_.next;
                                 _loc20_ = _loc22_.next;
                                 while(_loc20_ != null)
                                 {
                                    _loc23_ = _loc20_;
                                 ...
                                 _loc23_ = _loc20_ = _loc29_.lverts.next;
                                 _loc26_ += _loc22_.x * (_loc23_.y - _loc21_.y);
                                 _loc27_ = _loc23_.y * _loc22_.x - _loc23_.x * _loc22_.y;
                                 _loc29_.localCOMx += (_loc22_.x + _loc23_.x) * _loc27_;
                                 _loc29_.localCOMy += (_loc22_.y + _loc23_.y) * _loc27_;
            ...
            if(outer.drawShapeDetail)
            {
               ...
               var _temp_30:* = graphics;
               var _temp_29:* = outer_zn.thickness;
               _loc11_ = _loc5_;
               _loc13_ = 16711680;
               _loc7_ = 0.8;
               _loc14_ = (_loc11_ >> 16 & 0xFF) * _loc7_ + (_loc13_ >> 16 & 0xFF) * (1 - _loc7_);
               _loc15_ = (_loc11_ >> 8 & 0xFF) * _loc7_ + (_loc13_ >> 8 & 0xFF) * (1 - _loc7_);
               _loc16_ = (_loc11_ & 0xFF) * _loc7_ + (_loc13_ & 0xFF) * (1 - _loc7_);
               _temp_30.lineStyle(_temp_29,-16777216 | _loc14_ << 16 | _loc15_ << 8 | _loc16_,1);
               _loc7_ = 0;
               _loc8_ = 0;
               if(param4)
               {
               ...
               if(param4)
               {
                  graphics.drawRect(param1.aabb.minx,param1.aabb.miny,(_loc31_ = param1.aabb).maxx - _loc31_.minx,(_loc31_ = param1.aabb).maxy - _loc31_.miny);
               }
               else
               {
                  _loc9_ = 0;
      ...
      public function draw_body(param1:ZPP_Body, param2:ZPP_Mat23, param3:Number, param4:Boolean) : void
      {
         ...
         if(outer.drawBodyDetail)
         {
            ...
            var _temp_3:* = graphics;
            var _temp_2:* = outer_zn.thickness;
            _loc8_ = _loc7_;
            _loc13_ = 16711680;
            _loc9_ = 0.8;
            _loc14_ = (_loc8_ >> 16 & 0xFF) * _loc9_ + (_loc13_ >> 16 & 0xFF) * (1 - _loc9_);
            _loc15_ = (_loc8_ >> 8 & 0xFF) * _loc9_ + (_loc13_ >> 8 & 0xFF) * (1 - _loc9_);
            _loc16_ = (_loc8_ & 0xFF) * _loc9_ + (_loc13_ & 0xFF) * (1 - _loc9_);
            _temp_3.lineStyle(_temp_2,-16777216 | _loc14_ << 16 | _loc15_ << 8 | _loc16_,1);
            _loc9_ = 0;
            _loc10_ = 0;
            _loc11_ = 0;
            _loc17_ = 0;
            if(param1.shapes.head != null)
            {
                                    ...
                                    if(_loc18_.zip_localCOM)
                                    {
                                       ...
                                       if(_loc18_.type == ZPP_Flags.id_ShapeType_POLYGON)
                                       {
                                          ...
                                          else
                                          {
                                             ...
                                             _loc19_.localCOMy = 0;
                                             _loc20_ = 0;
                                             _loc22_ = _loc19_.lverts.next;
                                             _loc23_ = _loc22_.next;
                                             _loc21_ = _loc23_.next;
                                             while(_loc21_ != null)
                                             {
                                                _loc24_ = _loc21_;
                                             ...
                                             _loc24_ = _loc21_ = _loc19_.lverts.next;
                                             _loc20_ += _loc23_.x * (_loc24_.y - _loc22_.y);
                                             _loc25_ = _loc24_.y * _loc23_.x - _loc24_.x * _loc23_.y;
                                             _loc19_.localCOMx += (_loc23_.x + _loc24_.x) * _loc25_;
                                             _loc19_.localCOMy += (_loc23_.y + _loc24_.y) * _loc25_;
               ...
               if(param4)
               {
                  graphics.drawRect(param1.aabb.minx,param1.aabb.miny,(_loc28_ = param1.aabb).maxx - _loc28_.minx,(_loc28_ = param1.aabb).maxy - _loc28_.miny);
               }
               else
               {
                  _loc20_ = 0;
      ...
      public function draw_arbiter(param1:ZPP_Arbiter, param2:ZPP_Mat23, param3:Number, param4:Boolean) : void
      {
         ...
         if(param1.outer.zpp_inner.type == ZPP_Arbiter.SENSOR)
         {
            ...
            {
               _loc7_ = param1.outer;
               var _temp_2:* = graphics;
               var _temp_1:* = outer_zn.thickness;
               _loc8_ = 65280;
               _loc9_ = ~bg_col;
               _loc10_ = 0.7;
               _loc11_ = (_loc8_ >> 16 & 0xFF) * _loc10_ + (_loc9_ >> 16 & 0xFF) * (1 - _loc10_);
               _loc12_ = (_loc8_ >> 8 & 0xFF) * _loc10_ + (_loc9_ >> 8 & 0xFF) * (1 - _loc10_);
               _loc13_ = (_loc8_ & 0xFF) * _loc10_ + (_loc9_ & 0xFF) * (1 - _loc10_);
               _temp_2.lineStyle(_temp_1,-16777216 | _loc11_ << 16 | _loc12_ << 8 | _loc13_,1);
               if(param4)
               {
         ...
         else if(param1.outer.zpp_inner.type == ZPP_Arbiter.FLUID)
         {
            if(outer.drawFluidArbiters)
            {
               ...
               var _temp_77:* = graphics;
               var _temp_76:* = outer_zn.thickness;
               _loc8_ = 255;
               _loc9_ = ~bg_col;
               _loc10_ = 0.7;
               _loc11_ = (_loc8_ >> 16 & 0xFF) * _loc10_ + (_loc9_ >> 16 & 0xFF) * (1 - _loc10_);
               _loc12_ = (_loc8_ >> 8 & 0xFF) * _loc10_ + (_loc9_ >> 8 & 0xFF) * (1 - _loc10_);
               _loc13_ = (_loc8_ & 0xFF) * _loc10_ + (_loc9_ & 0xFF) * (1 - _loc10_);
               _temp_77.lineStyle(_temp_76,-16777216 | _loc11_ << 16 | _loc12_ << 8 | _loc13_,1);
               if(param4)
               {
         ...
         else if(outer.drawCollisionArbiters)
         {
            ...
            if(_loc23_.zpp_inner.user_length != 0)
            {
               ...
               if(_loc23_.zpp_inner.user_length == 2)
               {
                  ...
                  var _temp_101:* = graphics;
                  var _temp_100:* = outer_zn.thickness;
                  _loc8_ = 255;
                  _loc9_ = ~bg_col;
                  _loc30_ = 0.7;
                  _loc11_ = (_loc8_ >> 16 & 0xFF) * _loc30_ + (_loc9_ >> 16 & 0xFF) * (1 - _loc30_);
                  _loc12_ = (_loc8_ >> 8 & 0xFF) * _loc30_ + (_loc9_ >> 8 & 0xFF) * (1 - _loc30_);
                  _loc13_ = (_loc8_ & 0xFF) * _loc30_ + (_loc9_ & 0xFF) * (1 - _loc30_);
                  _temp_101.lineStyle(_temp_100,-16777216 | _loc11_ << 16 | _loc12_ << 8 | _loc13_,1);
                  if(_loc14_ != null && _loc14_.zpp_disp)
                  {
                     Boot.lastError = new Error();
                     throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
                  ...
                  graphics.lineTo(_loc5_,_loc6_);
                  var _temp_115:* = graphics;
                  var _temp_114:* = outer_zn.thickness;
                  _loc8_ = 16711680;
                  _loc9_ = ~bg_col;
                  _loc30_ = 0.7;
                  _loc11_ = (_loc8_ >> 16 & 0xFF) * _loc30_ + (_loc9_ >> 16 & 0xFF) * (1 - _loc30_);
                  _loc12_ = (_loc8_ >> 8 & 0xFF) * _loc30_ + (_loc9_ >> 8 & 0xFF) * (1 - _loc30_);
                  _loc13_ = (_loc8_ & 0xFF) * _loc30_ + (_loc9_ & 0xFF) * (1 - _loc30_);
                  _temp_115.lineStyle(_temp_114,-16777216 | _loc11_ << 16 | _loc12_ << 8 | _loc13_,1);
                  if(_loc14_ != null && _loc14_.zpp_disp)
                  {
                     Boot.lastError = new Error();
                     throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
               ...
               else
               {
                  ...
                  var _temp_137:* = graphics;
                  var _temp_136:* = outer_zn.thickness;
                  _loc8_ = 16711935;
                  _loc9_ = ~bg_col;
                  _loc28_ = 0.7;
                  _loc11_ = (_loc8_ >> 16 & 0xFF) * _loc28_ + (_loc9_ >> 16 & 0xFF) * (1 - _loc28_);
                  _loc12_ = (_loc8_ >> 8 & 0xFF) * _loc28_ + (_loc9_ >> 8 & 0xFF) * (1 - _loc28_);
                  _loc13_ = (_loc8_ & 0xFF) * _loc28_ + (_loc9_ & 0xFF) * (1 - _loc28_);
                  _temp_137.lineStyle(_temp_136,-16777216 | _loc11_ << 16 | _loc12_ << 8 | _loc13_,1);
                  graphics.drawCircle(_loc10_,_loc16_,1);
               }
               var _temp_139:* = graphics;
               var _temp_138:* = outer_zn.thickness;
               _loc8_ = ~bg_col;
               _loc9_ = bg_col;
               _loc28_ = 0.7;
               _loc11_ = (_loc8_ >> 16 & 0xFF) * _loc28_ + (_loc9_ >> 16 & 0xFF) * (1 - _loc28_);
               _loc12_ = (_loc8_ >> 8 & 0xFF) * _loc28_ + (_loc9_ >> 8 & 0xFF) * (1 - _loc28_);
               _loc13_ = (_loc8_ & 0xFF) * _loc28_ + (_loc9_ & 0xFF) * (1 - _loc28_);
               _temp_139.lineStyle(_temp_138,-16777216 | _loc11_ << 16 | _loc12_ << 8 | _loc13_,1);
