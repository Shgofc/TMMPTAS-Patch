package zpp_nape.util
{
   ...
   public class ZPP_Debug
   {
      ...
      public function xform_invalidate() : void
      {
         ...
         var _temp_1:*;
         §§pop().xdet = _loc1_ == 0 ? 0 : (_temp_1 = 1,_loc2_ = lf32((si32(((sf32(_loc1_,0),1597463007)) - (li32(0) >> 1),0),0)),_temp_1 / (_loc2_ * (1.5 - 0.5 * _loc1_ * _loc2_ * _loc2_)));
