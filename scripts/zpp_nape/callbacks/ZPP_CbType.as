package zpp_nape.callbacks
{
   ...
   public class ZPP_CbType
   {
      ...
      public static var ANY_SHAPE:nape.callbacks.CbType = new nape.callbacks.CbType();
      
      public static var ANY_BODY:nape.callbacks.CbType = new nape.callbacks.CbType();
      
      public static var ANY_COMPOUND:nape.callbacks.CbType = new nape.callbacks.CbType();
      
      public static var ANY_CONSTRAINT:nape.callbacks.CbType = new nape.callbacks.CbType();
